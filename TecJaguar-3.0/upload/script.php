...
if (isset($_FILES['imagem']) && $_FILES['imagem']['error'] == 0) {
    ...
    if (in_array($fileType, $validImageTypes)) {
        ...
        if (move_uploaded_file($file['tmp_name'], $destination)) {
            ...
            $imagem = 'upload/' . basename($file['name']); // Caminho relativo para o arquivo de imagem
            ...
            //HTML para visualizar imagem enviada
            if ($stmt->execute()) {
                ...
                echo '<img src="'.$imagem.'" alt="'.$nome_produto.'" width="200">';
            } else {
